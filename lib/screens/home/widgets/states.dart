  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          SizedBox(height: 6,),
          YourDepartmentCard(onTap: ()=>Get.toNamed(Routes.yourDeptScreen),),
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: ListTile(contentPadding:EdgeInsets.only(left: 90),
            title: Text(
              "Your Department",style: TextStyle(fontSize: 11.5),
            ),
            leading: Image.asset("assets/illinoishomepage/1.png",height: 35,),
          ),
        ),
      ),
    );
