...
class StationsScreen extends GetView<StationsController> {
            ...
            child: Column(
              children: [
                ...
                ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: controller.stationsList.length,
                  itemBuilder: (context, index) {
                    return GangSlangListWidget(
                      onTap: ()
                      =>Get.toNamed(Routes.stationsDetailScreen,arguments: controller.stationsList[index]),
                      text: controller.stationsList[index],
                    );
                  },
                ),
                SizedBox(height: 20,),
